# Writing Igbo messages for C7 — about 20 minutes
...
C7 (Videofy Live) is choosing a translation engine for Igbo. We can test
English → Igbo ourselves, but we cannot test **Igbo → English**, because
that needs real Igbo written by a Igbo speaker — and nobody on our team is
...
So: open `elicitation-ig.csv` and write **15 short messages in Igbo** — the
...
**Do not translate from English.** Write the Igbo first, as the message you
