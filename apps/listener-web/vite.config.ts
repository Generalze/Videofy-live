...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_PROGRESSIVE_TRANSLATED_AUDIO': JSON.stringify(
        fromEnv(rootEnv, 'VITE_PROGRESSIVE_TRANSLATED_AUDIO', ''),
      ),
      'import.meta.env.VITE_VIEWER_LATE_DROP_TOLERANCE_MS': JSON.stringify(
        fromEnv(rootEnv, 'VITE_VIEWER_LATE_DROP_TOLERANCE_MS', ''),
      ),
      'import.meta.env.VITE_VIEWER_SYNC_DELAY_MS': JSON.stringify(
        fromEnv(rootEnv, 'VITE_VIEWER_SYNC_DELAY_MS', ''),
      ),
